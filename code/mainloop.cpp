...
void main_interface2()
{
	...
	setfont(48, 0, "楷体");
	outtextxy(360, 250, "从头开始(A)");
	outtextxy(400, 300, "选关(X)");
	outtextxy(400, 350, "返回(R)");
...
void main_interfaceSM()
{
	...
	outtextxy(400, 250, "说明(Z)");

	setfont(24, 0, "楷体");

	outtextxy(220, 300, "关于撤销：只可在移动箱子后才可以使用此操作");
	outtextxy(220, 340, "关于大招：只可连续三次移动箱子以上后可使用");
	
	setfont(48, 0, "楷体");
	outtextxy(400, 380, "返回(R)");
	delimage(pimg_logo);
}
